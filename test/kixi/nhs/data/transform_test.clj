...
(deftest enrich-dataset-test
  (testing "Testing enriching dataset."
    ...
    (is (= [{:indicator_id "22" :value "85.7" :date "2013-14",
            ...
            {:indicator_id "22" :value "88.3"
             :date "2011-12" :period_of_coverage "1-7-2011 1-3-2012"}]
    ...
    (is (= [{:indicator_id "22" :value "85.7" :date "2013-14" :period_of_coverage "1-7-2013 1-3-2014"}
            {:indicator_id "22" :value "86.7" :date "2012-13" :period_of_coverage "1-7-2012 1-3-2013"}
            {:indicator_id "22" :value "88.3" :date "2011-12" :period_of_coverage "1-7-2011 1-3-2012"}]
           (transform/enrich-dataset
            {:indicator-id "22"
             :fields-to-extract [:indicator_value :year :period_of_coverage]
